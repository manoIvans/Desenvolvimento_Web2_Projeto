...
const SignalApi = (function () {
  ...
  async function BuscarAcronis() {
    return await chamarAhRota(ROTAS.Acronis, 'GET');
  }


  async function RefreshAcronis() {
    return await chamarAhRota(ROTAS.AcronisRefresh, 'POST');
  }
  ...
  async function ListarContasAcronis() {
    return await chamarAhRota(ROTAS.ContasAcronis, 'GET');
  }


  async function CriarContaAcronis(dados) {
    return await chamarAhRota(ROTAS.ContasAcronis, 'POST', dados);
  }


  async function AtualizarContaAcronis(id, dados) {
    return await chamarAhRota(`${ROTAS.ContasAcronis}/${id}`, 'PUT', dados);
  }


  async function RemoverContaAcronis(id) {
    return await chamarAhRota(`${ROTAS.ContasAcronis}/${id}`, 'DELETE');
  }
  ...
  return {
    BuscarZabbix, RefreshZabbix, BuscarMsp, RefreshMsp, BuscarAcronis, RefreshAcronis,
    ...
    ListarContasAcronis, CriarContaAcronis, AtualizarContaAcronis, RemoverContaAcronis,
    TokenAtual, Sair,
  };
})();
